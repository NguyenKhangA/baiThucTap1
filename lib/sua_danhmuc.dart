...
class _SuaDanhMuc extends State<SuaDanhMuc> {
  ...
  void initState(){
    ...
    _textEditingController.text = Provider.of<ListProviderDanhMuc>(context,listen: false).object['tendanhmuc'];
    super.initState();
  }
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                          onPressed: (){
                             Provider.of<ListProviderDanhMuc>(context,listen: false).updateDanhMuc(_textEditingController.text);
